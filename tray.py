...
class TrayIcon:
    ...
    def __init__(self, get_status_text, on_postpone, on_break_now, on_settings, on_quit):
        """
        ...
        on_quit: callable, вызывается при выходе
        """
    ...
    def _create_menu(self):
        ...
        items += [
            ...
            pystray.MenuItem(
                ...
                enabled=lambda item: self.can_postpone and not self.is_break_active,
            ),
            pystray.MenuItem(
                "Перерыв сейчас",
